...
exports.run = async (client, message, args, tools) => {
    ...
    let role15 = message.guild.roles.find(r => r.name === "Switch");
    let role16 = message.guild.roles.find(r => r.name === "Bloxburg");
    let role17 = message.guild.roles.find(r => r.name === "Owner");
    let role18 = message.guild.roles.find(r => r.name === "Small Business Direct-Deposit");
    let role19 = message.guild.roles.find(r => r.name === "Stardew Valley");
