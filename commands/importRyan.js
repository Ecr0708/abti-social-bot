...
exports.run = async (client, message, args, tools) => {
    ...
    let role7 = message.guild.roles.find(r => r.name === "Algebra");
    let role8 = message.guild.roles.find(r => r.name === "History");
    let role9 = message.guild.roles.find(r => r.name === "Spanish I");
    ...
    let role17 = message.guild.roles.find(r => r.name === "Garage Startup Direct-Deposit");
    let role18 = message.guild.roles.find(r => r.name === "Switch");
